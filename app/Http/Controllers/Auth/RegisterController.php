...
class RegisterController extends Controller
{
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'barangay' => ['required', 'in:Balucuc,Calantipe,Cansinala,Capalangan,Colgante,Paligui,Sampaloc,San Juan (Poblacion),San Vicente,Sucad,Sulipan,Tabuyuc (Santo Rosario)'],
